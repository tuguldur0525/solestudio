...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — Sole Studio" },
      {
        name: "description",
        content: "How Sole Studio collects, uses and protects your personal information.",
      },
      { property: "og:title", content: "Privacy Policy — Sole Studio" },
      { property: "og:description", content: "How Sole Studio handles your data." },
    ],
  }),
  component: Privacy,
});
...
const SECTIONS = [
  ...
  {
    t: "Who can see it",
    d: "Sole Studio staff who handle orders, and the courier delivering your parcel. Our website and database are operated on secured infrastructure with restricted access.",
  },
  {
    t: "Your choices",
  ...
  {
    t: "Contact",
    d: "Write to us on Instagram @solestudio_mn or visit the store at Tara Center 2F, Ulaanbaatar.",
  },
];
