...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in — Sole Studio" },
      {
        name: "description",
        content: "Sign in to your Sole Studio account to track orders and save favourites.",
      },
      { property: "og:title", content: "Sign in — Sole Studio" },
      { property: "og:description", content: "Access your Sole Studio account." },
