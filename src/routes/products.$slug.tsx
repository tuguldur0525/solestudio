...
export const Route = createFileRoute("/products/$slug")({
  head: ({ params }) => {
    ...
    const title = `${name} — Sole Studio`;
    return {
      meta: [
        { title },
        {
          name: "description",
          content: `${name} by Sole Studio — premium men's footwear, handmade finish, Mongolian sizes 39–45.`,
        },
        { property: "og:title", content: title },
        { property: "og:description", content: `${name} by Sole Studio.` },
        ...
        <div className="lg:pt-6">
          ...
          <div className="mt-8">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-muted-foreground">Mongolian sizing 39–45</span>
            </div>
