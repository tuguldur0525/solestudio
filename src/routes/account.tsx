...
export const Route = createFileRoute("/account")({
  head: () => ({
    meta: [
      { title: "My account — Sole Studio" },
      { name: "description", content: "View your Sole Studio orders and account details." },
      { property: "og:title", content: "My account — Sole Studio" },
      { property: "og:description", content: "Your Sole Studio orders and details." },
