...
export const Route = createFileRoute("/collections/$slug")({
  head: ({ params }) => {
    const title = `${params.slug.replace(/-/g, " ")} — Sole Studio`;
    return {
      meta: [
        { title },
        {
          name: "description",
          content: `Shop the Sole Studio ${params.slug.replace(/-/g, " ")} collection — premium men's footwear from Ulaanbaatar.`,
        },
        { property: "og:title", content: title },
        {
          property: "og:description",
          content: `The Sole Studio ${params.slug.replace(/-/g, " ")} collection.`,
        },
      ],
    };
  },
