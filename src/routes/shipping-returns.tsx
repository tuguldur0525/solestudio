...
export const Route = createFileRoute("/shipping-returns")({
  head: () => ({
    meta: [
      { title: "Shipping & Returns — Sole Studio" },
      {
        name: "description",
        content:
          "Sole Studio delivery times and fees across Mongolia, plus our 14-day exchange and return policy.",
      },
      { property: "og:title", content: "Shipping & Returns — Sole Studio" },
      { property: "og:description", content: "Delivery and returns at Sole Studio." },
    ],
  }),
