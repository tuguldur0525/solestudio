...
export const Route = createFileRoute("/admin")({
  head: () => ({
    meta: [
      { title: "Admin — Sole Studio" },
      { name: "description", content: "Sole Studio internal dashboard for products, stock and orders." },
      { property: "og:title", content: "Admin — Sole Studio" },
      { property: "og:description", content: "Sole Studio internal dashboard." },
    ...
    return (
      <div className="mx-auto max-w-md px-5 py-32 text-center">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          This account doesn't have admin access to the Sole Studio dashboard.
        </p>
      </div>
    );
  }
...
function NewProduct({
  ...
  return (
    <div className="max-w-xl space-y-3 border p-6">
      ...
      <p className="text-xs text-muted-foreground">
        Sizes 39–45 are created for every colour. Add more photos per colour from the Products tab.
      </p>
    </div>
  );
}
