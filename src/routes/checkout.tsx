...
export const Route = createFileRoute("/checkout")({
  head: () => ({
    meta: [
      { title: "Checkout — Sole Studio" },
      {
        name: "description",
        content: "Complete your Sole Studio order with delivery in Ulaanbaatar and across Mongolia.",
      },
      { property: "og:title", content: "Checkout — Sole Studio" },
      { property: "og:description", content: "Complete your Sole Studio order." },
